...
export function createSession(requirement, context) {
    const id = uuidv4();
...
export function calculateCompleteness(session) {
    ...
    categoryScores.constraints = categoryCounts.constraint.total > 0
        ...
        : 10;
    // Weighted overall
    const overall = Math.round(categoryScores.functional * categoryWeights.functional +
